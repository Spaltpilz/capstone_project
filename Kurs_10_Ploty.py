...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        fig = px.pie(values=success_counts.values, 
             ...
             labels={'label': 'Result', 'value': 'Count'},
        ...
        success_count2 = len(selected_site_df[selected_site_df['class'] == 1])
        failed_count2 = len(selected_site_df[selected_site_df['class'] == 0])
        # Create a pie chart figure
        fig = px.pie(values=[success_count2, failed_count2], 
